      ...
      <section>
        <div className='grid max-w-screen-xl px-4 pt-32 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28'>
          <div className='mr-auto place-self-center lg:col-span-7'>
            ...
            Gestión Inteligente <br />  de<br /> Préstamos
            </h1>
            <p class='max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400'>
            Solicita, gestiona y paga tus préstamos de manera rápida y segura. Visualiza tu historial financiero y toma mejores decisiones.
            </p>
      ...
      <section id='featured' className='mb-20'>
        <div className='max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6'>
          ...
          <div className='flex flex-col my-20 py-10 w-1/2 mx-auto text-center'>
            ...
            Nuestra Solución para una Gestión Eficiente
            </h2>
            <p class='mb-6 font-light text-gray-500  md:text-lg'>
            Facilitamos la administración de préstamos con herramientas avanzadas para gestión de clientes, pagos y reportes.
            </p>
          </div>
          ...
          <div className='flex gap-10 justify-between'>
            ...
            <div className='flex flex-col w-80 p-10  border rounded-xl hover:shadow-xl hover:bg-red-500 hover:text-white cursor-pointer'>
              ...
              <h4 className='text-md font-semibold mb-1'>Gestión de Préstamos</h4>
              <p>
              Simula tu crédito, configura montos y visualiza pagos futuros.
              </p>
            </div>
            ...
            <div className='flex flex-col w-80 p-10 rounded-xl border hover:shadow-xl hover:bg-red-500 hover:text-white cursor-pointer'>
              ...
              <h4 className='text-md font-semibold mb-1'>Gestión de Clientes</h4>
              <p>
              Consulta perfiles de clientes, evalúa su historial crediticio y aprueba préstamos.
              </p>
            </div>
            ...
            <div className='flex flex-col w-80 p-10 rounded-xl border hover:shadow-xl hover:bg-red-500 hover:text-white cursor-pointer '>
              ...
              <p>
                Automatiza pagos, recibe recordatorios y accede a reportes detallados
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6'>
          ...
          <div className='items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16'>
            ...
            <div className='text-gray-500 sm:text-lg'>
              ...
              Desde la solicitud hasta la aprobación, nuestro sistema te permite gestionar cada paso de manera eficiente.
              </p>
              ...
              >
                ...
                <li class='flex space-x-3'>
                  ...
                  <span class='text-base font-medium leading-tight text-gray-900 '>
                  Estado de aprobación del préstamo.
                  </span>
                </li>
                <li class='flex space-x-3'>
                  <svg
                  ...
                  <span class='text-base font-medium leading-tight text-gray-900 '>
                  Información del cliente evaluado.
                  </span>
                </li>
              </ul>
        ...
        <div class='max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10'>
          ...
          <div class='text-center'>
            ...
            <span class='block text-sm text-center text-gray-500 '>
              © 2025 Maogma™. All Rights Reserved Nazate-Villamarin-Torres.
            </span>
