...
export default function ApprovalWidgetUser() {
  ...
  return (
    <div className='w-full h-[450px] '>
      ...
      <div className=' mt-5 p-8 rounded-xl border border-t-4 border-t-red-500 cursor-pointer shadow-md'>
        <h3 className='text-xl mb-5 border-b-2'>Préstamos para aprobación</h3>
        <div className='flex justify-between items-center'>
          <div className='w-full h-[350px] overflow-auto hover:overflow-scroll'>
            <table className='table-fixed text-center w-full'>
              <thead>
                <tr className=''>
                  <th className='w-1/1 px-1 py-2'>Préstamo bruto</th>
                  <th className='w-1/1 px-1 py-2'>Estado</th>
                  <th className='w-1/6 px-1 py-2'>Vista</th>
                </tr>
              </thead>
              <tbody>
                        ...
                        <tr key={index}>
                          ...
                          <td className='border px-4 py-2  bg-gray-50'>
                            <button className='bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full '>
                              <Link to={`/editLoanUserUser/${loan.id}`}>
