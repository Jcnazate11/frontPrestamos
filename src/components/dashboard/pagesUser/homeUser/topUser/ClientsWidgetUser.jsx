...
export default function ClientsWidgetUser() {
    ...
    <div className='w-full'>
      ...
      >
        <div className='flex justify-between items-center'>
          <span className='text-xl'>Prestatarios</span>
        </div>
        <div className='my-3 '>
        ...
        <span className='text-base text-gray-500'>Total de clientes atendidos</span>
      </div>
    </div>
  );
}
