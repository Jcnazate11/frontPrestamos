...
export default function MessageUser({ email }) {
            ...
            <form onSubmit={sendEmail} class='space-y-8'>
              ...
              <div className='flex w-full gap-5'>
                ...
                <div className='w-full'>
                  ...
                  <input
                    ...
                    name='fullname'
                    value={fullname}
                    placeholder='Elije un prestatario'
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  id='subject'
                >
                  <option value='Loan Approval'>Aprobación de préstamo</option>
                  <option value='Loan Denied'>Préstamo Rechazado</option>
                  <option value='Loan Disbursed'>Préstamo Desembolsado</option>
                </select>
              </div>
