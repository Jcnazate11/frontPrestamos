...
const GetBorrowersUser = ({ setAuth }) => {
            ...
            <table className='table-fixed text-center'>
              <thead className=''>
                <tr className=''>
                  ...
                  <th className='w-1/1 px-1 py-2 text-gray-600'>Acción</th>
                </tr>
              </thead>
              <tbody>
                {clients.length <= 0 ? (
                  <tr className='border px-4 py-2 bg-red-50'>
                    <td></td>
                    <td></td>
                    <td className='px-4 py-2 bg-red-50'>Sin datos del cliente</td>
                    <td></td>
                    <td></td>
                  </tr>
                ) : (
...
export default GetBorrowersUser;
