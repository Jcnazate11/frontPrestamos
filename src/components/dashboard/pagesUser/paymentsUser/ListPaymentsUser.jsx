      ...
      <table className='table-fixed text-center '>
        <thead>
          <tr>
            ...
            <th className='w-1/5 px-1 py-2 text-gray-600'>Cantidad</th>
            <th className='w-1/5 px-4 py-2 text-gray-600'>Fecha de recogida</th>
            <th className='w-1/5 px-1 py-2 text-gray-600'>Nuevo Balance</th>
            <th className='w-1/5 px-4 py-2 text-gray-600'>Recogido por:</th>
            <th className='w-1/5 px-4 py-2 text-gray-600'>Método</th>
            <th className='w-1/5 px-4 py-2 text-gray-600'>Eliminar</th>
          </tr>
        </thead>
        <tbody>
          {payments.length <= 0 ? (
            <tr className='border px-4 py-2 bg-red-50'>
              ...
              <td></td>
              <td></td>
              <td className='px-4 py-2 bg-red-50'>Sin datos de pago</td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
...
export default PaymentsInfoUser;
